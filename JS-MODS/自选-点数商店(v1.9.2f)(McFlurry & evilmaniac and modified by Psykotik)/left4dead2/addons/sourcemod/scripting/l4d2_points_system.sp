...
void InitSettings() {
	...
	g_eGeneral.cSettings[SettingStartPoints]		= CreateConVar("l4d2_points_start", "2000", "玩家初始积分");
	g_eGeneral.cSettings[SettingNotifications]		= CreateConVar("l4d2_points_notify", "0", "开关提示信息?");
	g_eGeneral.cSettings[SettingTankLimit] 			= CreateConVar("l4d2_points_tank_limit", "1", "每回合允许购买多少只坦克");
...
void InitCategories() {
	...
	g_eGeneral.cCategories[CategoryTraitor]		= CreateConVar("l4d2_points_cat_traitor", "0", "启用内鬼项目购买");
	g_eGeneral.cCategories[CategorySpecial] 	= CreateConVar("l4d2_points_cat_special", "0", "启用特殊项目购买");
...
void InitItemCosts() {
	g_eGeneral.cItemCosts[CostP220]				= CreateConVar("l4d2_points_pistol", "25", "购买小手枪需要多少积分");
	g_eGeneral.cItemCosts[CostMagnum] 			= CreateConVar("l4d2_points_magnum", "50", "购买马格南手枪需要多少积分");
	g_eGeneral.cItemCosts[CostUZI] 				= CreateConVar("l4d2_points_smg", "80", "购买乌兹冲锋枪需要多少积分");
	g_eGeneral.cItemCosts[CostSilenced] 		= CreateConVar("l4d2_points_silenced", "100", "购买消音冲锋枪需要多少积分");
	g_eGeneral.cItemCosts[CostMP5] 				= CreateConVar("l4d2_points_mp5", "80", "购买MP5冲锋枪需要多少积分");
	g_eGeneral.cItemCosts[CostM16] 				= CreateConVar("l4d2_points_m16", "150", "购买M16突击步枪需要多少积分");
	g_eGeneral.cItemCosts[CostAK47] 			= CreateConVar("l4d2_points_ak47", "180", "购买AK47突击步枪需要多少积分");
	g_eGeneral.cItemCosts[CostSCAR] 			= CreateConVar("l4d2_points_scar", "150", "购买SCAR-H突击步枪需要多少积分");
	g_eGeneral.cItemCosts[CostSG552] 			= CreateConVar("l4d2_points_sg552", "125", "购买SG552突击步枪需要多少积分");
	g_eGeneral.cItemCosts[CostMilitary] 		= CreateConVar("l4d2_points_military", "220", "购买30发连发狙击枪需要多少积分");
	g_eGeneral.cItemCosts[CostAWP] 				= CreateConVar("l4d2_points_awp", "750", "购买awp狙击枪需要多少积分");
	g_eGeneral.cItemCosts[CostScout] 			= CreateConVar("l4d2_points_scout", "550", "购买侦察狙击步枪(鸟狙)需要多少积分");
	g_eGeneral.cItemCosts[CostHunting] 			= CreateConVar("l4d2_points_hunting", "180", "购买狩猎狙击步枪(猎枪)需要多少积分");
	g_eGeneral.cItemCosts[CostPump] 			= CreateConVar("l4d2_points_pump", "80", "购买一代木喷需要多少积分");
	g_eGeneral.cItemCosts[CostChrome] 			= CreateConVar("l4d2_points_chrome", "80", "购买二代铁喷需要多少积分");
	g_eGeneral.cItemCosts[CostAuto] 			= CreateConVar("l4d2_points_auto", "160", "购买一代连喷需要多少积分");
	g_eGeneral.cItemCosts[CostSPAS] 			= CreateConVar("l4d2_points_spas", "160", "购买二代连喷需要多少积分");
	g_eGeneral.cItemCosts[CostGrenade] 			= CreateConVar("l4d2_points_grenade", "1000", "购买榴弹发射器需要多少积分");
	g_eGeneral.cItemCosts[CostM60] 				= CreateConVar("l4d2_points_m60", "1500", "购买M60机枪需要多少积分");
	g_eGeneral.cItemCosts[CostGasCan] 			= CreateConVar("l4d2_points_gascan", "500", "购买汽油桶需要多少积分");
	g_eGeneral.cItemCosts[CostOxygen] 			= CreateConVar("l4d2_points_oxygen", "200", "购买氧气罐需要多少积分");
	g_eGeneral.cItemCosts[CostPropane] 			= CreateConVar("l4d2_points_propane", "200", "购买燃气罐需要多少积分");
	g_eGeneral.cItemCosts[CostGnome] 			= CreateConVar("l4d2_points_gnome", "150", "购买侏儒人偶需要多少积分");
	g_eGeneral.cItemCosts[CostCola] 			= CreateConVar("l4d2_points_cola", "200", "购买可乐瓶需要多少积分");
	g_eGeneral.cItemCosts[CostFireworks] 		= CreateConVar("l4d2_points_fireworks", "200", "购买烟花盒需要多少积分");
	g_eGeneral.cItemCosts[CostFireaxe] 			= CreateConVar("l4d2_points_fireaxe", "150", "购买消防斧需要多少积分");
	g_eGeneral.cItemCosts[CostFryingpan]		= CreateConVar("l4d2_points_fryingpan", "100", "购买平底锅需要多少积分");
	g_eGeneral.cItemCosts[CostMachete] 			= CreateConVar("l4d2_points_machete", "150", "购买小砍刀需要多少积分");
	g_eGeneral.cItemCosts[CostBaseballbat] 		= CreateConVar("l4d2_points_baseballbat", "100", "购买棒球棒需要多少积分");
	g_eGeneral.cItemCosts[CostCrowbar] 			= CreateConVar("l4d2_points_crowbar", "150", "购买撬棍需要多少积分");
	g_eGeneral.cItemCosts[CostCricketbat] 		= CreateConVar("l4d2_points_cricketbat", "100", "购买板球棒需要多少积分");
	g_eGeneral.cItemCosts[CostTonfa] 			= CreateConVar("l4d2_points_tonfa", "100", "购买警棍需要多少积分");
	g_eGeneral.cItemCosts[CostKatana] 			= CreateConVar("l4d2_points_katana", "200", "购买武士刀需要多少积分");
	g_eGeneral.cItemCosts[CostElectricguitar]	= CreateConVar("l4d2_points_electricguitar", "100", "购买电吉他需要多少积分");
	g_eGeneral.cItemCosts[CostKnife] 			= CreateConVar("l4d2_points_knife", "150", "购买小刀需要多少积分");
	g_eGeneral.cItemCosts[CostGolfclub] 		= CreateConVar("l4d2_points_golfclub", "100", "购买高尔夫球棍需要多少积分");
	g_eGeneral.cItemCosts[CostShovel] 			= CreateConVar("l4d2_points_shovel", "50", "购买铁铲需要多少积分");
	g_eGeneral.cItemCosts[CostPitchfork] 		= CreateConVar("l4d2_points_pitchfork", "25", "购买干草叉需要多少积分");
	g_eGeneral.cItemCosts[CostCustomMelee] 		= CreateConVar("l4d2_points_custommelee", "300", "购买自定义近战需要多少积分");
	g_eGeneral.cItemCosts[CostChainsaw] 		= CreateConVar("l4d2_points_chainsaw", "20", "购买电锯需要多少积分");
	g_eGeneral.cItemCosts[CostPipe] 			= CreateConVar("l4d2_points_pipe", "200", "购买土制炸弹需要多少积分");
	g_eGeneral.cItemCosts[CostMolotov] 			= CreateConVar("l4d2_points_molotov", "300", "购买燃烧瓶需要多少积分");
	g_eGeneral.cItemCosts[CostBile] 			= CreateConVar("l4d2_points_bile", "150", "购买胆汁需要多少积分");
	g_eGeneral.cItemCosts[CostHealthKit]		= CreateConVar("l4d2_points_medkit", "350", "购买医疗包需要多少积分");
	g_eGeneral.cItemCosts[CostDefib] 			= CreateConVar("l4d2_points_defib", "80", "购买电击器需要多少积分");
	g_eGeneral.cItemCosts[CostAdren] 			= CreateConVar("l4d2_points_adrenaline", "150", "购买肾上腺素需要多少积分");
	g_eGeneral.cItemCosts[CostPills] 			= CreateConVar("l4d2_points_pills", "120", "购买止痛药需要多少积分");
	g_eGeneral.cItemCosts[CostExplosiveAmmo] 	= CreateConVar("l4d2_points_explosive_ammo", "35", "购买高爆弹药需要多少积分");
	g_eGeneral.cItemCosts[CostIncendiaryAmmo] 	= CreateConVar("l4d2_points_incendiary_ammo", "35", "购买燃烧弹药需要多少积分");
	g_eGeneral.cItemCosts[CostExplosivePack] 	= CreateConVar("l4d2_points_explosive_ammo_pack", "55", "购买高爆弹药包需要多少积分");
	g_eGeneral.cItemCosts[CostIncendiaryPack] 	= CreateConVar("l4d2_points_incendiary_ammo_pack", "55", "购买燃烧弹药包需要多少积分");
	g_eGeneral.cItemCosts[CostLaserSight] 		= CreateConVar("l4d2_points_laser", "50", "购买激光瞄准器需要多少积分");
	g_eGeneral.cItemCosts[CostHeal] 			= CreateConVar("l4d2_points_survivor_heal", "500", "购买回满血量需要多少积分");
	g_eGeneral.cItemCosts[CostAmmo] 			= CreateConVar("l4d2_points_refill", "50", "购买弹药补充需要多少积分");
	g_eGeneral.cItemCosts[CostSuicide] 			= CreateConVar("l4d2_points_suicide", "80", "特感玩家购买自杀需要多少积分");
	g_eGeneral.cItemCosts[CostPZHeal] 			= CreateConVar("l4d2_points_infected_heal", "300", "感染者治愈自己需要多少积分");
	...
	g_eGeneral.cItemCosts[CostWitch] 			= CreateConVar("l4d2_points_witch", "2000", "购买一次witch需要多少积分");
	...
	g_eGeneral.cItemCosts[CostTraitor] 			= CreateConVar("l4d2_points_traitor", "200", "购买一个感染者位置需要多少积分");
}
