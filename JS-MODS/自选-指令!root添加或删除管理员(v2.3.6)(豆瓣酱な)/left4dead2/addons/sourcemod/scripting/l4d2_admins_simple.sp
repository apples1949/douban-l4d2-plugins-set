...
#define PLUGIN_VERSION	"2.3.7"	//版本号.
...
ArrayList LineArray, SiteArray, ListArray;
...
void GetPlayerLists()
{
	char sSteamId[32], sName[32];
	
	for(int i = 1; i <= MaxClients; i++)
	{
		if(IsClientInGame(i) && !IsFakeClient(i) && GetClientAuthId(i, AuthId_Steam2, sSteamId, sizeof(sSteamId)) && !GetPlayerStatus(sSteamId))
		{
