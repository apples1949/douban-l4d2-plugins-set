...
int    g_iTankSwitch, g_iTankPrompt, g_iTankHealth, g_iWitchSwitch, g_iWitchBasics, g_iWitchHealth;
ConVar g_hTankSwitch, g_hTankPrompt, g_hTankHealth, g_hWitchSwitch, g_hWitchBasics, g_hWitchHealth;
